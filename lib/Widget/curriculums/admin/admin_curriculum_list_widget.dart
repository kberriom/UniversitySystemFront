...
class AdminCurriculumListWidget extends ConsumerStatefulWidget {
  const AdminCurriculumListWidget({super.key});

  @override
  ConsumerState<AdminCurriculumListWidget> createState() => _AdminCurriculumsWidgetState();
}

class _AdminCurriculumsWidgetState extends ConsumerState<AdminCurriculumListWidget> with AnimationMixin {
