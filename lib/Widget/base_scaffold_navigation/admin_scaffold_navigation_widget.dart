...
class AdminScaffoldNavigationWidget extends StatelessWidget {
          ...
          IconButton(
            ...
            icon: PopupMenuButton(
              ...
              itemBuilder: (context) => <PopupMenuEntry>[
                PopupMenuItem(child: Text(context.localizations.signOutPopupMenu), onTap: () => ref.read(loginProvider.notifier).signOut()),
              ],
            ),
            onPressed: () {},
          ),
